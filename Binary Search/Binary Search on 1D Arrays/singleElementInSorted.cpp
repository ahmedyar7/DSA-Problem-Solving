...
class Solution {
 public:
  ...
  //     /*
  //       1. If the mid is even and the mid element and the element next to it
  //       i.e mid+1 are same then this mean that the mid element is still on
  //       the right half

  //       2. If the mid is odd and the mid element and the element previous to
  //       it i.e mid-1 are same then this means that the element is still on
  //       the right half.
